...
public class QuestionBank {
    ...
    public  ArrayList<Question> correctQuestions = new ArrayList<>();
    public  ArrayList<Question> wrongQuestions = new ArrayList<>();
    public  ArrayList<Question> notAnsweredQuestions = new ArrayList<>();
    public  final Question question001 = new Question(1, R.drawable.image_001, 3 ,
    ...
    public  final Question question002 = new Question(2, R.drawable.image_002, 2 ,
    ...
    public  final Question question003 = new Question(3, R.drawable.image_003, 2 ,
            "Նշված դեպքում ո՞ր գոտուց պետք է կատարվի աջ շրջադարձը:" ,
            "Միայն երկրորդ գոտուց",
            "Միայն «A» գծանշումով նշված աջ եզրային գոտուց:");


    public  final Question question004 = new Question(4, 3 ,
    ...
    public  final Question question005 = new Question(5, R.drawable.image_004, 1 ,
            "Թույլատրվու՞մ է արդյոք մուտք գործել բակ նշված տեղից:" ,
            "Թույլատրվում է",
            "Արգելվում է");


    public  final Question question006 = new Question(6,   2 ,
    ...
    public  final Question question007 = new Question(7, R.drawable.image_005, 3 ,
    ...
    public  final Question question008 = new Question(8, R.drawable.image_006, 1 ,
    ...
    public  final Question question009 = new Question(9, 5 ,
    ...
    public  final Question question010 = new Question(10, R.drawable.image_007, 2 ,
    ...
    public  final Question question011 = new Question(11, R.drawable.image_008, 2 ,
            "Ո՞ր պատասխանում է ճիշտ նշված երթևեկության թույլատրելի\n" + "ուղղությունը:" ,
    ...
    public  final Question question012 = new Question(12, 1 ,
    ...
    public  final Question question013 = new Question(13, 4,
    ...
    public  final Question question014 = new Question(14, R.drawable.image_009, 2 ,
    ...
    public  final Question question015 = new Question(15, R.drawable.image_010, 1 ,
    ...
    public  final Question question016 = new Question(16, R.drawable.image_011, 2 ,
    ...
    public  final Question question017 = new Question(17,  1 ,
    ...
    public  final Question question018 = new Question(18, R.drawable.image_012, 2 ,
    ...
    public  final Question question019  = new Question(19, R.drawable.image_013, 2 ,
    ...
    public  final Question question020  = new Question(20, R.drawable.image_014, 2 ,
    ...
    public  final Question question021  = new Question(21,  2 ,
    ...
    public  final Question question022  = new Question(22, R.drawable.image_015, 1 ,
    ...
    public  final Question question023  = new Question(23,  5 ,
            "Հետադարձն արգելվում է՝" ,
    ...
    public  final Question question024  = new Question(24, R.drawable.image_016, 2 ,
    ...
    public  final Question question025 = new Question(25, R.drawable.image_017, 4 ,
    ...
    public  final Question question026 = new Question(26,  1 ,
    ...
    public  final Question question027 = new Question(27, R.drawable.image_018, 1 ,
    ...
    public  final Question question028 = new Question(28, R.drawable.image_019, 1 ,
    ...
    public  final Question question029 = new Question(29, 3 ,
    ...
    public  final Question question030 = new Question(30, R.drawable.image_020, 2 ,
            "Ո՞ր տրանսպորտային միջոցի վարորդը պետք է զիջի ճանապարհը" ,
            "Տրակտորի վարորդը",
            "Ավտոբուսի վարորդը");


    public  final Question question031 = new Question(31, R.drawable.image_021, 2 ,
    ...
    public  final Question question032 = new Question(32, 1 ,
    ...
    public  final Question question033 = new Question(33, R.drawable.image_022, 1,
            "Ո՞ր տրանսպորտային միջոցի վարորդը պետք է զիջի ճանապարհը:" ,
            "Թեթև մարդատար ավտոմոբիլի վարորդը",
            "Բեռնատար ավտոմոբիլի վարորդը");


    public  final Question question034 = new Question(34, R.drawable.image_023, 2 ,
            "Ո՞ր տրանսպորտային միջոցի վարորդը պետք է զիջի ճանապարհը:" ,
            "Ավտոբուսի վարորդը",
            "Ավտոմոբիլի վարորդը");


    public  final Question question035 = new Question(35, R.drawable.image_024, 1 ,
            "Ո՞ր տրանսպորտային միջոցի վարորդը պետք է զիջի ճանապարհը" ,
            "Ավտոմոբիլի վարորդը",
            "Տրամվայի վարորդը");


    public  final Question question036 = new Question(36, R.drawable.image_025, 2 ,
            "Նշե՛ք խաչմերուկի անցման հերթականությունը`" ,
            "Ավտոբուսը, բեռնատար ավտոմոբիլը, լծասայլը",
            "Ավտոբուսը և լծասայլը, բեռնատար ավտոմոբիլը");


    public  final Question question037 = new Question(37, R.drawable.image_003, 2 ,
    ...
    public  final Question question038 = new Question(38, R.drawable.image_003, 2 ,
    ...
    public  final Question question039 = new Question(39, R.drawable.image_003, 2 ,
    ...
    public  final Question question040 = new Question(40, R.drawable.image_026, 3 ,
    ...
    public  final Question question041 = new Question(41, R.drawable.image_027, 1 ,
    ...
    public  final Question question042 = new Question(42, R.drawable.image_028, 1 ,
            "Ո՞ր տրանսպորտային միջոցի վարորդն ունի առաջնահերթ երթևեկության\n" +
                    "իրավունք" ,
            "Թեթև մարդատար ավտոմոբիլի վարորդը",
            "Ավտոբուսի վարորդը");
    ...
    public  final Question question043 = new Question(43, R.drawable.image_029, 1 ,
            "Ո՞ր տրանսպորտային միջոցի վարորդն ունի առաջնահերթ երթևեկության\n" +
    ...
    public  final Question question044 = new Question(44, R.drawable.image_030, 2 ,
    ...
    public  final Question question045 = new Question(45, R.drawable.image_031, 1 ,
    ...
    public  final Question question046 = new Question(46, R.drawable.image_032, 1 ,
    ...
    public  final Question question047 = new Question(47, R.drawable.image_033, 2 ,
    ...
    public  final Question question048 = new Question(48, R.drawable.image_034, 2 ,
    ...
    public  final Question question049 = new Question(49, R.drawable.image_035, 2 ,
            "Տվյալ իրադրությունում ունե՞ք արդյոք նշված մանևրի իրավունք:" ,
            "Այո",
            "Ոչ");


    public  final Question question050 = new Question(50, R.drawable.image_036, 3 ,
    ...
    public  final Question question051 = new Question(51, R.drawable.image_037, 2 ,
    ...
    public  final Question question052 = new Question(52, R.drawable.image_038, 1 ,
    ...
    public  final Question question053 = new Question(53, R.drawable.image_039, 1 ,
            "Դուք շարունակում եք երթևեկությունն ուղիղ, ո՞ր տրանսպորտային\n" +
                    "միջոցին պետք է զիջեք ճանապարհը:" ,
            "Միայն թեթև մարդատար ավտոմոբիլին",
            "Ոչ մեկին",
    ...
    public  final Question question054 = new Question(54, R.drawable.image_040, 3 ,
    ...
    public  final Question question055 = new Question(55, R.drawable.image_041, 2 ,
    ...
    public  final Question question056 = new Question(56, R.drawable.image_042, 2 ,
    ...
    public  final Question question057 = new Question(57, R.drawable.image_043, 2 ,
            "Եթե մտադիր եք խաչմերուկում կատարել ձախ շրջադարձ, ո՞ր\n" +
                    "տրանսպորտային միջոցին պետք է զիջեք ճանապարհը:" ,
            "Ոչ մեկին",
            "Միայն ավտոբուսին",
    ...
    public  final Question question058 = new Question(58, R.drawable.image_044, 1 ,
            "Եթե մտադիր եք խաչմերուկում կատարել հետադարձ, ո՞ր\n" +
                    "տրանսպորտային միջոցին պետք է զիջեք ճանապարհը:" ,
            "Բեռնատար ավտոմոբիլին",
            "Թեթև մարդատար ավտոմոբիլին",
    ...
    public  final Question question059 = new Question(59, R.drawable.image_045, 4 ,
            "Եթե մտադիր եք կատարել ձախ շրջադարձ, ո՞ր տրանսպորտային\n" +
                    "միջոցին պետք է զիջեք ճանապարհը:" ,
            "Ավտոբուսին",
    ...
    public  final Question question060 = new Question(60, R.drawable.image_046, 2,
    ...
    public  final Question question061 = new Question(61, R.drawable.image_047, 1 ,
    ...
    public void bindAllQuestionsToArray(){
        allQuestions.clear();
    ...
    public  void bindCorrectQuestionsToArray(){
    ...
    public  void bindWrongQuestionsToArray(){
    ...
    public  void bindNotAnsweredQuestionsToArray(){
